...
const jobRecords: JobRecord[] = jobs.map((j) => ({
  ...j,
  jobReference: `SAT-${j.id.toUpperCase()}`,
  department: j.discipline,
  numberOfVacancies: 1,
  experienceRequired: j.requirements[0],
  education: j.requirements.find((item) => /degree|diploma/i.test(item)),
...
const applications: JobApplication[] = [
  ...
  },
  {
    ...
    currentJobTitle: "Airport Systems Technician",
    yearsExperience: 4,
    qualification: "Technical Diploma",
    currentCity: "Jeddah",
    applicationSource: "SATCO Careers website",
    criteriaMatch: "needs-review",
    status: "new",
    createdAt: now,
  },
  {
