...
await seedTable(
  ...
  [
    ...
    ["preferred_qualifications", "preferredQualifications", true],
    ["screening_questions", "screeningQuestions", true],
...
await seedTable(
  ...
  [
    ...
    ["screening_answers", "screeningAnswers", true],
    ["criteria_match", "criteriaMatch"],
    ["internal_notes", "internalNotes", true],
